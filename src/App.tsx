      ...
      <div className="flex flex-col items-center bg-[#121212] w-full h-full">
        <div className="flex flex-col bg-[#121212] w-full h-full text-white">
          ...
          >
            ...
            <div className="rounded-xl lg:rounded-2xl w-full h-80 min-[500px]:h-[28rem] md:h-[30rem] lg:h-[36rem] xl:h-full bg-no-repeat bg-cover bg-top md:bg-[auto_140%] lg:bg-[auto_120%] xl:bg-[auto_150%] md:bg-[center_top_-10px] lg:bg-[center_top_-20px] bg-[url('/src/assets/images/yinka.jpg')] xl:col-span-5"></div>
          </div>
          <div
            id="studies"
